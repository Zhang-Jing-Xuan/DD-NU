# python pretrain_latent.py -d latent_nette --nclass 10 -n convnet --depth 3  --pt_from 2 --seed 2023
...
def main(args, logger, repeat=1):
    data, target = torch.load(os.path.join("/root/autodl-tmp/results/dit-distillation/imagenet-10-1000-nette/", 'data.pt'))
