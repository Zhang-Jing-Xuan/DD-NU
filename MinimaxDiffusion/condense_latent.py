# python condense_latent.py --reproduce -d latent -f 1 --ipc 10 -n convnet --depth 3 --model_path "/root/autodl-tmp/MinimaxDiffusion/pretrained_models/latent/conv3in_cut_seed_0_lr_0.01_aug_color_crop_cutout/" --niter 1000 --inner_loop 10 --tag debug
# python condense_latent.py --reproduce -d latent -f 1 --ipc 20 -n convnet --depth 3 --model_path "/root/autodl-tmp/MinimaxDiffusion/pretrained_models/latent/conv3in_cut_seed_0_lr_0.01_aug_color_crop_cutout/" --niter 1000 --inner_loop 10 --tag grad20_750_4 
import os
import numpy as np
import torch
...
def condense(args, logger, device='cuda'):
    ...
    ### initial training
    os.system(f"python train.py -d imagenet --imagenet_dir ../results/dit-distillation/imagenet-10-200-minimax /root/autodl-tmp/MinimaxDiffusion/data/imagenet/     -n convnet --depth 6 --norm_type instance --nclass 10 --norm_type instance --ipc {args.ipc} --tag test --slct_type random --spec woof")
    os.system(f"python train.py -d imagenet --imagenet_dir ../results/dit-distillation/imagenet-10-200-minimax /root/autodl-tmp/MinimaxDiffusion/data/imagenet/     -n resnet_ap --nclass 10 --norm_type instance --ipc {args.ipc} --tag test --slct_type random --spec woof")
    os.system(f"python train.py -d imagenet --imagenet_dir ../results/dit-distillation/imagenet-10-200-minimax /root/autodl-tmp/MinimaxDiffusion/data/imagenet/     -n resnet --depth 18 --norm_type instance --nclass 10 --norm_type instance --ipc {args.ipc} --tag test --slct_type random --spec woof")
    ...
    for it in range(args.niter):
        ...
        path="/root/autodl-tmp/MinimaxDiffusion/pretrained_models/latent/conv3in_cut_seed_0_lr_0.01_aug_color_crop_cutout/checkpoint_best_0.pth.tar"
        ...
        for ot in range(args.inner_loop):
            ...
            for c in range(nclass):
                ...
                loss = matchloss(args, img_aug[:n], img_aug[n:], lab, lab_syn, model,it) *4
        ...
        # if (it + 1) % 10 == 0:
            ...
            if not args.test:
                ...
                if args.factor>1:
                    ...
                    path1="../results/dit-distillation/imagenet-10-100_200-minimax-distill"
                    path2=os.path.join(args.save_dir, f'data_best.pt')
                    os.system(f"python latent2images.py --model DiT-XL/2 --image-size 256 --ckpt ../logs/run-0/000-DiT-XL-2-minimax/checkpoints/0012000.pt --save-dir {path1} --spec woof --num-samples {args.ipc} --synpath {path2}")
                    os.system(f"python train.py -d imagenet --imagenet_dir {path1} /root/autodl-tmp/MinimaxDiffusion/data/imagenet/     -n convnet --depth 6 --nclass 10 --norm_type instance --ipc {args.ipc} --tag test --slct_type random --spec woof")
                    os.system(f"python train.py -d imagenet --imagenet_dir {path1} /root/autodl-tmp/MinimaxDiffusion/data/imagenet/     -n resnet_ap --nclass 10 --norm_type instance --ipc {args.ipc} --tag test --slct_type random --spec woof")
                    os.system(f"python train.py -d imagenet --imagenet_dir {path1} /root/autodl-tmp/MinimaxDiffusion/data/imagenet/     -n resnet --depth 18 --nclass 10 --norm_type instance --ipc {args.ipc} --tag test --slct_type random --spec woof")
