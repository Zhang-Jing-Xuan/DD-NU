...
class Logger():
    def __init__(self, path):
        ###
        # self.logger = open("/root/autodl-tmp/MinimaxDiffusion/results/latent/conv3in_debug_extend_feat_mse_pt2_nd2000_inloop15_cut_niter1000_factor1_lr0.05_random_ipc100/log.txt", 'a')
        self.logger = open("/root/autodl-tmp/MinimaxDiffusion/results/latent/conv3in_grad20_750_4_grad_mse_pt2_nd2000_inloop10_cut_niter1000_factor1_lr0.05_random_ipc20/log.txt", 'a')
        # self.logger = open("/root/autodl-tmp/MinimaxDiffusion/results/latent/tsne/log.txt","a")
