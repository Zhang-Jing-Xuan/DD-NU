...
```bash
python train.py -d imagenet --imagenet_dir /root/autodl-tmp/MinimaxDiffusion/data/imagenet/ \
    -n resnet_ap --nclass 10 --norm_type instance --ipc 100 --tag test --slct_type random --spec woof --save_ckpt True
```
