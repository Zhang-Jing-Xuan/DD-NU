...
class ImageFolder(datasets.DatasetFolder):
    ...
    def __init__(self,
        ...
        for i in self.class_to_idx.keys():
            path=os.path.join(self.root,str(i),".ipynb_checkpoints")
            os.system(f"rm -rf {path}")
    ...
    def find_subclasses(self, nclass=100, phase=0, seed=0):
        ...
        if seed == 0:
            ...
            elif self.spec == 'ImageNet10':
                file_list = './misc/class_imagenet10.txt'
            elif self.spec == 'bird':
                file_list = './misc/class_bird.txt'
            elif self.spec == 'fruit':
                file_list = './misc/class_fruit.txt'
            elif self.spec == '1k':
